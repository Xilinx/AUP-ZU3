...
proc create_hier_cell_iop_grove { parentCell nameHier } {
  ...
  assign_bd_address -offset 0x40800000 -range 0x00010000 -target_address_space /${nameHier}/mb/Data [get_bd_addr_segs /${nameHier}/iic0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40810000 -range 0x00010000 -target_address_space /${nameHier}/mb/Data [get_bd_addr_segs /${nameHier}/iic1/S_AXI/Reg] -force
